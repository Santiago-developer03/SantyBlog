            ...
            <div class="w-full p-6 rounded-lg shadow-lg">
              ...
              <form action="{{ route('categories.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                  ...
                  <input type="text" id="category" name="category" class="w-full text-gray-600 font-bold px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500" autocomplete="off">
                  @error('category')
